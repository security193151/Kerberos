...
public class Login extends JFrame implements ActionListener {
	...
	private JTextField KC=new JTextField(22);
	...
	public void actionPerformed(ActionEvent event) {
		...
		if(event.getSource()==button1){
			...
			//	Pattern pattern_name = Pattern.compile(regEx_name, Pattern.CASE_INSENSITIVE);//不区分大小写
				...
				{
					socket1 = new Socket("192.168.43.71",1110);//与AS连接
					...
					socket2 = new Socket("192.168.43.158",2222);//与TGS连接
					...
					socket3 = new Socket("192.168.43.244",3333);//与Server连接
